...
function showDedicationText() { //seguidores
  ...
  if (!text) {
      text = `Para nay:\n\nHolaa, es la primera vez que hago esto, espero que salga bien, tuve algunas clases de programación y viendo tutoriales lo aprendí, no quiero ser denso ni tampoco molestarte. Quería recordarte lo mucho que te extraño, que tengo muchas ganas de verte. Siento que hay  cosas importantes que decirnos  y que valen la pena. Yo estoy contando las horas para ese momento la verdad.\n\nOjalá vos también tengas las mismas ganas, pienso mucho en hacer las cosas mejor y demostrarte que estoy aprendiendo día a día a ser una buena persona <3`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, jo";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2022-10-16T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-04-24T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Te amo desde hace: <b>${days}</b> días<br>` +
      `Próxima vez juntos: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
